...
import 'package:calendar_exemple/appointment_store.dart';
...
class _CalendarPageState extends State<CalendarPage> {
  ...
  Widget build(BuildContext context) {
    final format = context.watch<AppointmentStore>().calendar.format;
          ...
          children: [
            ...
            Expanded(
              child: EventTable(
                ...
                events: context.watch<AppointmentStore>().clinicalAppointments,
              ),
            ),
          ],
        ),
...
class EventTable extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final startOfWeek = this.startOfWeek.date;

    Animate.restartOnHotReload = true;
    Animate.defaultDuration = 1200.ms;
    Animate.defaultCurve = Curves.fastOutSlowIn;

    final events = this.events.where((e) =>
        (e.startAt >= startOfWeek) && e.startAt < (startOfWeek + 1.weeks));
...
class MyEventCell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SuperHero(
      ...
      maxWidth: 560,
      child: LayoutBuilder(builder: (context, constraints) {
        final isOpen = constraints.maxWidth > 200;
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (isOpen)
                Expanded(
                  child: AddAppointmentDialog().animate(delay: 300.ms).fadeIn(),
                ),
            ],
          ),
        );
      ...
      child: Column(
        children: [
          ListTile(
            dense: true,
            leading:
                SvgPicture.asset('assets/images/calendar_add.svg', width: 24),
            title: Text(
              'Agendar Consulta',
              style: TextStyle(
                fontSize: 24,
                fontWeight: FontWeight.w600,
                color: Color(0xFF5184E4),
              ),
            ),
          ),
          Divider(
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        prefixIcon: Padding(
                          padding:
                              const EdgeInsets.symmetric(vertical: 4).copyWith(
                            left: 8,
                            right: 4,
                          ),
                        ...
                        hintText: 'Digite 3 letras para buscar...',
                        hintStyle: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w300,
                        ),
                        ...
                        enabledBorder: OutlineInputBorder(
                          borderSide: BorderSide(
                              color: Color(0xFF5184E4).withOpacity(0.4)),
                        ),
                      ),
                    ),
                  ),
